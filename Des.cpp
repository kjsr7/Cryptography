 ...
 keygen();
  for(iB=0,nB=0,m=0;m<(strlen(Text)/8);m++)
  {
       ...
       for(K=0;K<8;K++,iB++) total[iB]=B[K];
        ...
        cout<<"after initial permuatation of plain text "<<endl;
        for(int i=0;i<64;i++)
        cout<<total[i];
        cout<<endl;
        ...
        Expansion();
        cout<<"After Expansion P box"<<endl;
        for(int i=0;i<48;i++)
        cout<<expansion[i];
        cout<<endl;
        cout<<"the key used in this round is "<<endl;
        for(int i=0;i<48;i++)
        cout<<keyi[round -1][i];
        cout<<endl;
        xor_oneE(round);
        cout<<"after xor with the key"<<endl;
        for(int i=0;i<48;i++)
        cout<<xor1[i];
        cout<<endl;
        substitution();
        ...
        permutation();
        cout<<"after 8 sboxes and straight p box "<<endl;
        for(int i=0;i<32;i++)
        cout<<p[i];
        cout<<endl;
        xor_two();
...
cout<<endl;
 ...
 int t;
 cout<<endl;
 cout<<"enter to start decryption "<<endl;
 cin>>t;
...
void Des::keygen()
{
  ...
  for(i=28;i<56;i++)
        ...
        for(round=1;round<=16;round++)
        {
                ...
                /*      cout<<"the key for round "<<round<<" is"<<endl;
        for(int i=0;i<48;i++)
        cout<<keyi[round-1][i];
	*/
	}
